...
async def run(conversation_id, ask: str):
    async with ConversationCache() as db_cache:
        ...
        user_data = await db_cache.get_user_data(conversation_id+":user_data") or {"trip_type": None, "number_of_travelers": None,"traveler_type": None, "travel_dates": None}
    ...
    return response, is_agent_required, data, is_data_changed